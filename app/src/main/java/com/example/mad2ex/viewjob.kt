...
class viewjob : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val button = findViewById<Button>(R.id.apply_btn)
        button.setOnClickListener {
            val intent = Intent(this, applyjob::class.java) // Replace NextActivity with the actual name of the activity you want to navigate to
